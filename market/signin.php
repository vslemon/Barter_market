	...
	<div class="row">
		<div class="col-sm-12">
			<div class="main-content">
				<div class="header">
					<h3 style="text-align: center;"><strong>Login to Barter Market</strong></h3>
				</div>
				<div class="l-part">
					<form action="" method="post">
						...
						<a style="text-decoration: none;float: right;color: #196f3d;" data-toggle="tooltip" title="Create Account" href="signup.php">Don't have an account?</a><br><br>
