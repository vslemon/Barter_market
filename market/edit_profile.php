		...
		<div class="col-sm-8">
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table table-bordered table-hover">
					...
					<tr>
						<td style="font-weight: bold;">Desription</td>
						<td>
...
<?php
	if(isset($_POST['update'])){
		...
		$update = "update users set f_name='$f_name', l_name='$l_name', user_name='$u_name', user_desc='$describe_user', user_pass='$u_pass', user_email='$u_email', user_country='$u_country', user_gender='$u_gender', user_birthday='$u_birthday' where user_id='$user_id'";
