	...
	<div class="row">
		<div class="col-sm-12">
			<div class="main-content">
				<div class="header">
					<h3 style="text-align: center;"><strong>Join Barter Market</strong></h3>
					<hr>
				</div>
				<div class="l-part">
					<form action="" method="post">
						...
						<div class="input-group">
							...
							<select class="form-control" name="u_country" placeholder="Select your country" required="required">
						...
						<a style="text-decoration: none;float: right;color: #196f3d;" data-toggle="tooltip" title="Signin" href="signin.php">Already have an account?</a><br><br>
